import * as contactsServices from '../services/contactsRouter.js';
...
const getOneContactByArabicName = async (req, res) => {
    const contact = await contactsServices.getContactByArabicName(
        req.params.arabicName
    );
...
export default {
    ...
    getOneContactByArabicName: toController(getOneContactByArabicName),
